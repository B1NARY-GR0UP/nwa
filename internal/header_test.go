...
func TestIsGenerated(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "go generated with LF",
			content:  []byte("// Code generated by foobar. DO NOT EDIT.\npackage main\n"),
			expected: true,
		},
		{
			name:     "go generated with CRLF",
			content:  []byte("// Code generated by foobar. DO NOT EDIT.\r\npackage main\r\n"),
			expected: true,
		},
		{
			name:     "go generated with hash comment and LF",
			content:  []byte("# Code generated by foobar. DO NOT EDIT.\npackage main\n"),
			expected: true,
		},
		{
			name:     "go generated with hash comment and CRLF",
			content:  []byte("# Code generated by foobar. DO NOT EDIT.\r\npackage main\r\n"),
			expected: true,
		},
		{
			name:     "cargo raze with LF",
			content:  []byte("DO NOT EDIT! Replaced on runs of cargo-raze\npackage main\n"),
			expected: true,
		},
		{
			name:     "cargo raze with CRLF",
			content:  []byte("DO NOT EDIT! Replaced on runs of cargo-raze\r\npackage main\r\n"),
			expected: true,
		},
		{
			name:     "non-generated file",
			content:  []byte("// Copyright 2025 BINARY Members\npackage main\n"),
			expected: false,
		},
		{
			name:     "partial match is not generated",
			content:  []byte("// Code generated by foobar.\npackage main\n"),
			expected: false,
		},
	}
